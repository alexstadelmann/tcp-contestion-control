...
document.addEventListener('DOMContentLoaded', () => {
  //Add x axis numbers
  let number = 1
  const viewBoxWidth = document.querySelector('#diagramSvg').viewBox.baseVal.width
  ...
  //Add y axis numbers
  number = 1
  const viewBoxHeight = document.querySelector('#diagramSvg').viewBox.baseVal.height
  console.log(viewBoxWidth)
